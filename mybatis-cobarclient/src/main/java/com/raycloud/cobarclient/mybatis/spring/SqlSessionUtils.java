 ...
 *
 * @version $Id: SqlSessionUtils.java 4894 2012-03-12 10:12:09Z simone.tripodi $
 */
public final class SqlSessionUtils {
    ...
    public static SqlSession getSqlSession(SqlSessionFactory sessionFactory,
        ...
        return getSqlSession(sessionFactory, executorType, exceptionTranslator, environment, null);
    }

    public static SqlSessionHolder currentSqlSessionHolder(SqlSessionFactory sessionFactory) {
        return (SqlSessionHolder) getResource(sessionFactory);
    }
...
//            Environment environment = sessionFactory.getConfiguration().getEnvironment();
     ...
     * @return
     */
    private static SqlSession openSession(Environment environment, SqlSessionFactory sessionFactory, ExecutorType executorType) {
        Transaction tx = null;
        try {
